 ...
 *
 * <p>Stringers only encode well-formed org.json.JSON strings. In particular:
 * <ul>
 ...
 * </ul>
 * Calls that would result in a malformed org.json.JSON string will fail with a
 * {@link JSONException}.
 *
...
public class JSONStringer {
    ...
    enum Scope {
        ...
        NONEMPTY_OBJECT,
        /**
         * A special bracketless array needed by org.json.JSONStringer.join() and
         * org.json.JSONObject.quote() only. Not used for org.json.JSON encoding.
         */
        NULL,
    }
    /**
    ...
    /**
     * Returns the encoded org.json.JSON string.
     *
