...
/**
 * Parses a org.json.JSON (<a href="http://www.ietf.org/rfc/rfc4627.txt">RFC 4627</a>)
 ...
 *         + "}";
 *
 * org.json.JSONObject object = (org.json.JSONObject) new org.json.JSONTokener(json).nextValue();
 * String query = object.getString("query");
 * org.json.JSONArray locations = object.getJSONArray("locations");</pre>
 *
 * <p>For best interoperability and performance use org.json.JSON that complies with
 ...
 * input string was valid org.json.JSON. All of the following syntax errors will be
 * ignored:
 * <ul>
 ...
 * </ul>
 *
 * <p>Each tokener may be used to parse a single org.json.JSON string. Instances of this
...
public class JSONTokener {
    ...
    private int pos;
    /**
     * @param in org.json.JSON encoded string. Null is not permitted and will yield a
    ...
    private int nextCleanInternal() throws JSONException {
        while (pos < in.length()) {
            ...
            switch (c) {
                ...
                case '#':
                    /*
                     * Skip a # hash end-of-line comment. The org.json.JSON RFC doesn't
     ...
     * Legacy APIs.
     *
     * None of the methods below are on the critical path of parsing org.json.JSON
     ...
     * for org.json.JSON strings that contain the character '\0'.
     */
    public char next() {
     ...
     * method is ambiguous for org.json.JSON strings that contain the character '\0'.
     */
