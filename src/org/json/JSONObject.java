 ...
 *       fails with a {@code org.json.JSONException} if the requested name has no value
 ...
 * named entry from the object but {@code put(name, org.json.JSONObject.NULL)} stores an
 * entry whose value is {@code org.json.JSONObject.NULL}.
 *
...
public class JSONObject {
     ...
     *   <li>are included in the encoded org.json.JSON string.
     * </ul>
     *
    ...
    /**
     * Creates a {@code org.json.JSONObject} with no name/value mappings.
     */
    public JSONObject() {
        nameValuePairs = new LinkedHashMap<String, Object>();
    }
    /**
     * Creates a new {@code org.json.JSONObject} by copying all name/value mappings from
     * the given map.
     *
    ...
    /**
     * Creates a new {@code org.json.JSONObject} with name/value mappings from the next
    ...
    public JSONObject(JSONTokener readFrom) throws JSONException {
         ...
         * parse to temporary org.json.JSONObject and then steal the data from that.
         */
        Object object = readFrom.nextValue();
        if (object instanceof JSONObject) {
            this.nameValuePairs = ((JSONObject) object).nameValuePairs;
        } else {
            throw JSON.typeMismatch(object, "org.json.JSONObject");
        }
    }
    /**
     * Creates a new {@code org.json.JSONObject} with name/value mappings from the org.json.JSON
     * string.
     *
     * @param json a org.json.JSON-encoded string containing an object.
    ...
    /**
     * Creates a new {@code org.json.JSONObject} by copying mappings for the listed names
    ...
    public JSONObject append(String name, Object value) throws JSONException {
        ...
        if (current instanceof JSONArray) {
            ...
            throw new JSONException("Key " + name + " is not a org.json.JSONArray");
        }
        array.checkedPut(value);
        return this;
    }
     ...
     * Note that org.json.JSON represents numbers as doubles,
     * so this is <a href="#lossy">lossy</a>; use strings to transfer numbers via org.json.JSON.
     *
     * @throws JSONException if the mapping doesn't exist or cannot be coerced
     *     to a long.
     */
    ...
    /**
     * Returns the value mapped by {@code name} if it exists and is a long or
     * can be coerced to a long, or 0 otherwise. Note that org.json.JSON represents numbers as doubles,
     * so this is <a href="#lossy">lossy</a>; use strings to transfer numbers via org.json.JSON.
     */
    ...
    /**
     * Returns the value mapped by {@code name} if it exists and is a long or
     * can be coerced to a long, or {@code fallback} otherwise. Note that org.json.JSON represents
     * numbers as doubles, so this is <a href="#lossy">lossy</a>; use strings to transfer
     * numbers via org.json.JSON.
     */
     ...
     * org.json.JSONArray}, or throws otherwise.
     *
    ...
    public JSONArray getJSONArray(String name) throws JSONException {
        ...
        if (object instanceof JSONArray) {
            ...
            throw JSON.typeMismatch(name, object, "org.json.JSONArray");
        }
    }
    /**
     * Returns the value mapped by {@code name} if it exists and is a {@code
     * org.json.JSONArray}, or null otherwise.
     */
    ...
    /**
     * Returns the value mapped by {@code name} if it exists and is a {@code
     * org.json.JSONObject}, or throws otherwise.
     *
     * @throws JSONException if the mapping doesn't exist or is not a {@code
     *     org.json.JSONObject}.
     */
    public JSONObject getJSONObject(String name) throws JSONException {
        ...
        if (object instanceof JSONObject) {
            ...
            throw JSON.typeMismatch(name, object, "org.json.JSONObject");
        }
    }
    /**
     * Returns the value mapped by {@code name} if it exists and is a {@code
     * org.json.JSONObject}, or null otherwise.
     */
    ...
    /**
     * Encodes this object as a compact org.json.JSON string, such as:
    ...
    /**
     * Encodes this object as a human readable org.json.JSON string for debugging, such
     * as:
     * <pre>
     * {
     *     "query": "Pizza",
    ...
    /**
     * Encodes the number as a org.json.JSON string.
     *
    ...
    /**
     * Encodes {@code data} as a org.json.JSON string. This applies quotes and any
     ...
     * If the object is a {@code org.json.JSONArray} or {@code org.json.JSONObject}, no wrapping is necessary.
     * If the object is {@code NULL}, no wrapping is necessary.
     * If the object is an array or {@code Collection}, returns an equivalent {@code org.json.JSONArray}.
     * If the object is a {@code Map}, returns an equivalent {@code org.json.JSONObject}.
